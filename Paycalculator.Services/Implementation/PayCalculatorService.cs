...
using Paycalculator.Persistence;

namespace Paycalculator.Services.Implementation
{
    public class PayCalculatorService : IPayCalculatorService
    {
        ...
        public PayCalculatorService(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public decimal NetPay(decimal totalEarnings, decimal totalReduction) => totalEarnings - totalReduction;
        ...
        public decimal TotalReduction(decimal tax, decimal nic, decimal studentLoanRepayment)
        => tax - nic - studentLoanRepayment;
    }
}
