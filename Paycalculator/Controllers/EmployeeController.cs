    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create(EmployeeCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var employee = new Employee
                {
                    ...
                    NationalInsuranceNumber = model.NationalInsuranceNo,
                ...
                if (model.ImageUrl != null && model.ImageUrl.Length > 0)
                {
                    ...
                    var FileName = DateTime.UtcNow.ToString("yymmssfff") + fileName + extension;
        ...
        public IActionResult Edit(int id)
        {
            ...
            var model = new EmployeeEditViewModel()
            {
                ...
                DOB = employee.DOB,
                DateJoined = employee.DateJoined,
                NationalInsuranceNo = employee.NationalInsuranceNumber,
        ...
        public async Task<IActionResult> Edit(EmployeeEditViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                employee.NationalInsuranceNumber = model.NationalInsuranceNo;
